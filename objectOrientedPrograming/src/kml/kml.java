...
public class kml {
	...
	public static void makeKmlFile(ArrayList<String[]> toDisplay, String path){// æàú äôåð÷öéä îäúé÷ééä ùì ä÷.î.ì àí úöèøê òåã äñáøéí ú÷ùø àìéé.
	...
	//ONEPLUS A3003
	private static String convertTimeFormat(String oldTimeFormat) { /// ñòéó îñôø 7
